...
Scheme
{
	...
	// Custom styles for use with L4D360HybridButtons
		...
		HybridButton.FocusColor						"240 240 240 255"
		HybridButton.FocusColor						"255 255 255 255"
		HybridButton.BorderColor					"GreyBlue"
		HybridButton.DisabledColor					"140 140 140 255"
		HybridButton.Font						"DialogMenuItem"
		HybridButton.SymbolFont						"MarlettLarge"
		HybridButton.BlotchColor					"Orange"
		...
		// Main Menu theme colors
		MainMenu.MainColor                            "192 143 59 255"
		MainMenu.MainDarkColor                          "128 91 40 255"
		MainMenu.MainDarkestColor                       "102 73 32 255"
	}
