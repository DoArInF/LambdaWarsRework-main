"Resource/UI/Audio.res"
{
	...
	"DrpOrderSounds"
	{
		...
		"BtnDropButton"
		{
			...
			"tabPosition"				"1"
			"AllCaps"					"1"
			"labelText"					"#GameUI_OrderSounds"
			"tooltiptext"				"#L4D360UI_AudioOptions_Tooltip_OrderSounds"
			"disabled_tooltiptext"		"#L4D360UI_AudioOptions_Tooltip_OrderSounds_Disabled"
			"style"						"DropDownButton"
			"command"					"FlmOrderSounds"
			"ActivationType"			"1"
			"OnlyActiveUser"			"1"
		}
	}
	...
	{
		"ControlName"			"FlyoutMenu"
		"fieldName"				"FlmOrderSounds"
		"visible"				"0"
		"wide"					"0"
		"tall"					"0"
		"zpos"					"4"
		"InitialFocus"			"BtnOff"
		"ResourceFile"			"resource/UI/basemodui/DropDownOrderSounds.res"
		"OnlyActiveUser"		"1"
	}
